...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFja2hhbnNlbiIsImEiOiJjbHU4Nmg1em4wY2V1MmtuMGxjZmFyNjJmIn0.NUeH60Lwfq5j0Vske_653g';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/jackhansen/clu96krnz006v01r56v025ig5',
    // style URL
    scrollZoom: false
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51P12fvHl97cPgFYKAcnaPdbzwwKl9NzQahmixiIEN55somuMbwC8TrSnzF4IrAKosoR9xfv59BxOS9M7ufxhBUjY00iQsqjQ3c');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your account has been signed up successfully');
            window.setTimeout(function () {
              location.assign('/me');
            }, 1500);
          }
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            (0, _alerts.showAlert)('error', _context.t0.message); // Display error to the user
          case 14:
          case "end":
            return _context.stop();
        }
